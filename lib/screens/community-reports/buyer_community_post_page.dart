import 'package:agro_mart/screens/community-reports/buyer_chat_page.dart';
import 'package:agro_mart/widgets/buyer_app_bar.dart';
...
class _CommunityPostsPageState extends State<CommunityPostsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Community Posts'),
      body: Column(
        children: [
          _showSearchBar
              ? Padding(
